...
\\
From figure \ref{fig:15} we see both our own logistic regression code and Scikit's achieving a high accuracy test score. Own logistic regression performs slightly better than Scikit's for almost all $\eta$ and $\lambda$ values achieving a maximum accuracy score of 0.96 with $\eta = 0.1$. Scikit's SGDClassifier achieves a maximum accuracy test score of 0.94.\\
\\
